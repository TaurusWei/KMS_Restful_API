package com.sansec.common.crypto.ethereum;
...
public class EthECKeyPair extends ECKeyPair {
    ...
    public String getPrivateKey() {
        return Base64Tools.HexUtils.toHex(getRawPrivateKey());
    }
    ...
    public byte[] getRawAddress() {
        byte[] byteAddress = Base64Tools.KECCAK256.keccak256(getRawPublicKey());
    ...
    public String getAddress() {
        return Base64Tools.HexUtils.toHex(getRawAddress());
    }
