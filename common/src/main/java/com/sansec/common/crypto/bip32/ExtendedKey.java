 ...
 */
package com.sansec.common.crypto.bip32;


import com.sansec.common.crypto.ECKeyPair;
import com.sansec.common.crypto.ECPublicKey;
...
public class ExtendedKey {
    ...
    public String serialize(boolean production) {
        ...
        return Base64Tools.Base58Check.bytesToBase58(out.toByteArray());
    }

    public static ExtendedKey parse(String serialized) throws ValidationException {
        byte[] data = Base64Tools.Base58Check.base58ToBytes(serialized);
        if (data.length != 78) {
