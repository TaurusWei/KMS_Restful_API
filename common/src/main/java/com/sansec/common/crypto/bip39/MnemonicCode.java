...
package com.sansec.common.crypto.bip39;



import com.sansec.common.crypto.bip39.wordlists.English;
...
public class MnemonicCode {
    ...
    //默认为英文
    private WordList wordList = English.INSTANCE;
    ...
    public MnemonicCode(WordList list) {
        wordList = list;
    }
...
//        Log.i(TAG + "PBKDF2 took {}ms", (System.currentTimeMillis() - start) + "");
        return seed;
    }
    ...
    public byte[] toEntropy(List<String> words) throws MnemonicException.MnemonicLengthException,
        ...
        byte[] hash = Base64Tools.SHA256.sha256(entropy);
