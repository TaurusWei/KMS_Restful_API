package com.sansec.common.result;
/**
...
//=========	区块链模块 =========
	...
	//用户模块
	public static CodeMsg BLOCK_LOGIN_ERROR = new CodeMsg(510001, "login error");

	//密钥模块
	public static CodeMsg BLOCK_GENERATE_KEY_ERROR = new CodeMsg(510101, "generate key error");
